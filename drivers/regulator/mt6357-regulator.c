...
#if IS_ENABLED(CONFIG_LGE_PM_VIO18_DISABLE_LPM)
    regmap_update_bits(mt6397->regmap,
               MT6357_RG_LDO_VIO18_HW0_OP_EN_ADDR,
               MT6357_RG_LDO_VIO18_HW0_OP_EN_MASK <<
               MT6357_RG_LDO_VIO18_HW0_OP_EN_SHIFT, 0);
    regmap_update_bits(mt6397->regmap,
               MT6357_RG_LDO_VIO18_HW2_OP_EN_ADDR,
               MT6357_RG_LDO_VIO18_HW2_OP_EN_MASK <<
               MT6357_RG_LDO_VIO18_HW2_OP_EN_SHIFT, 0);
#endif
#if IS_ENABLED(CONFIG_LGE_PM_VIO28_DISABLE_LPM)
    regmap_update_bits(mt6397->regmap,
               MT6357_RG_LDO_VIO28_HW0_OP_EN_ADDR,
               MT6357_RG_LDO_VIO28_HW0_OP_EN_MASK <<
               MT6357_RG_LDO_VIO28_HW0_OP_EN_SHIFT, 0);
    regmap_update_bits(mt6397->regmap,
               MT6357_RG_LDO_VIO28_HW2_OP_EN_ADDR,
               MT6357_RG_LDO_VIO28_HW2_OP_EN_MASK <<
               MT6357_RG_LDO_VIO28_HW2_OP_EN_SHIFT, 0);
#endif
	return 0;
}
