...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.checksum_value = 0xdb6e1e1f,  //0x5622f670,
	.pre = {
		.pclk = 84000000,
		.linelength = 2192,
		.framelength = 1276,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
	...
	{1600, 1200, 0, 0, 1600, 1200, 1600, 1200, 0000, 0000, 1600, 1200, 0, 0, 1600, 1200},  /*custom1 23fps */
};
		...
		do {
			*sensor_id = return_sensor_id() + 1;
			if (*sensor_id == imgsensor_info.sensor_id) {
				strcpy(depth_sensor_name, "gc02m1bdepth_cxt");/*LGE_CHANGE, 2020-11-06, add the camera identifying logic , bk.bae@lge.com*/
				LOG_INF("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
				#if GC02M1B_EEPROM_ENABLE
				if (0x20 == imgsensor.i2c_write_id) {
					hw_info_main3_otp.sensor_name = PFX;
				} else if (0x6e == imgsensor.i2c_write_id) {
					hw_info_main3_otp.sensor_name = "gc02m1_camera_sensor";
				}
				#endif
				return ERROR_NONE;
			}
...
UINT32 GC02M1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	printk("GC02M1B_MIPI_RAW_SensorInit.\n");
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}
