...
enum IMGSENSOR_RETURN imgsensor_hw_init(struct IMGSENSOR_HW *phw)
{
	...
	pr_err("[SAT] imgsensor_hw_init start \n");
	...
	pr_err("[SAT] imgsensor_hw_init start 2\n");
	...
	pr_err("[SAT] imgsensor_hw_init start 3\n");
	...
	pr_err("[SAT] imgsensor_hw_init exit\n");
	return IMGSENSOR_RETURN_SUCCESS;
}
	...
	char *pcurr_idx)
{
	...
	pr_err("[SAT] imgsensor_hw_power_sequence start\n");
	...
	enum IMGSENSOR_HW_POWER_STATUS pwr_status)
{
	...
	pr_err(
		"[SAT] sensor_idx %d, power %d curr_sensor_name %s, enable list %s\n",
		sensor_idx,
		pwr_status,
		curr_sensor_name,
