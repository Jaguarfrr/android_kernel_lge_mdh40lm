...
#include "fh10_hi556_front_st_mipi_Sensor.h"

#define PFX "hi556_camera_sensor"
#define LOG_INF(format, args...)    pr_debug(PFX "[%s] " format, __FUNCTION__, ##args)

extern char front_sensor_name[20];/*LGE_CHANGE, 2021-01-12, add the camera identifying logic , bk.bae@lge.com*/

#define MULTI_WRITE 1

//+bug577281 zhoumin.wt, add, 2020/11/6, second supply camera otp porting
#define EEPROM_BL24SA64DCS_ID 0xA0
static kal_uint16 read_eeprom(kal_uint32 addr)
{
	kal_uint16 get_byte=0;

	char pu_send_cmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
	iReadRegI2C(pu_send_cmd, 2, (u8*)&get_byte, 1, EEPROM_BL24SA64DCS_ID);
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = FH10_HI556_FRONT_ST_SENSOR_ID,
	...
	.cap = {
		...
		.linelength = 2816,
		//.framelength = 2049,
		.framelength = 2082,//bug 577281,huangguoyong.wt,modify,2020.11.16,modify for hi556 mipi test fail
		.startx = 0,
		.starty = 0,
...
write_cmos_sensor(0x0958, 0xe980);
write_cmos_sensor(0x095a, 0x7750);
...
kal_uint16 addr_data_pair_capture_fps_hi556[] = {
	...
	0x0030, 0x1111,
	0x0032, 0x1111,
	0x0006, 0x1044, //frame length line
	0x0a22, 0x0000,
	0x0a12, 0x0a20,
	0x0a14, 0x0798,
	0x003e, 0x0000,
	0x0074, 0x1046, //coarse integration time
	0x0070, 0x0400,
	0x0804, 0x0200,
	0x0a04, 0x014a,
	0x090c, 0x0fdc,
...
//	write_cmos_sensor(0x0a00, 0x0000); // stream off
	if( currefps == 300 )
	{
		...
		write_cmos_sensor(0x0a14, 0x0798);
		write_cmos_sensor(0x003e, 0x0000);
		write_cmos_sensor(0x0074, 0x0820); //coarse integration time
	...
	else
	{
		...
		write_cmos_sensor(0x0a14, 0x0798);
		write_cmos_sensor(0x003e, 0x0000);
		write_cmos_sensor(0x0074, 0x1046);
		write_cmos_sensor(0x0070, 0x0400);
		write_cmos_sensor(0x0804, 0x0200);
		write_cmos_sensor(0x0a04, 0x014a);
		write_cmos_sensor(0x090c, 0x0fdc);
...
static struct stCAM_CAL_DATAINFO_STRUCT fh10_hi556_front_st_eeprom_data ={
	.sensorID= FH10_HI556_FRONT_ST_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x077C,
...
static struct stCAM_CAL_CHECKSUM_STRUCT fh10_hi556_front_st_checksum[8] =
{
			...
			do {
				*sensor_id =return_sensor_id();
				if (*sensor_id == imgsensor_info.sensor_id) {
					//+bug577281 zhoumin.wt, add, 2020/11/6, second supply camera otp porting
					size = imgSensorReadEepromData(&fh10_hi556_front_st_eeprom_data,fh10_hi556_front_st_checksum);
					if(size != fh10_hi556_front_st_eeprom_data.dataLength || (fh10_hi556_front_st_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
						pr_err("get eeprom data failed\n");
						if(fh10_hi556_front_st_eeprom_data.dataBuffer != NULL) {
							kfree(fh10_hi556_front_st_eeprom_data.dataBuffer);
							fh10_hi556_front_st_eeprom_data.dataBuffer = NULL;
						}
						*sensor_id = 0xFFFFFFFF;
						return ERROR_SENSOR_CONNECT_FAIL;
					} else {
						pr_info("get eeprom data success\n");
						imgSensorSetEepromData(&fh10_hi556_front_st_eeprom_data);
					}
					strcpy(front_sensor_name, "hi556front_shine");/*LGE_CHANGE, 2021-01-12, add the camera identifying logic , bk.bae@lge.com*/
					//-bug577281 zhoumin.wt, add, 2020/11/6, second supply camera otp porting
...
UINT32 FH10_HI556_FRONT_ST_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
