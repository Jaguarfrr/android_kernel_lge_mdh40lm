...
#if defined(FH10_HI1336_REAR_SY_MIPI_RAW)
	{
		SENSOR_DRVNAME_FH10_HI1336_REAR_SY_MIPI_RAW,
		{
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
			{DVDD, Vol_1200, 1},
...
#if defined(FH10_S5K3L6_REAR_DC_MIPI_RAW)
	{
		SENSOR_DRVNAME_FH10_S5K3L6_REAR_DC_MIPI_RAW,
		{
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_High, 0},
			{DVDD, Vol_1100, 0},
...
#if defined(FH10_HI846_FRONT_ST_MIPI_RAW)
	{
		SENSOR_DRVNAME_FH10_HI846_FRONT_ST_MIPI_RAW,
		{
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1200, 1},
			{AVDD, Vol_2800, 1},
...
#if defined(FH10_GC5035_FRONT_LHYX_MIPI_RAW)
	{
		SENSOR_DRVNAME_FH10_GC5035_FRONT_LHYX_MIPI_RAW,
		{
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1200, 1},
			{AVDD, Vol_2800, 1},
...
#if defined(FH10_HI556_FRONT_ST_MIPI_RAW)
	{
		SENSOR_DRVNAME_FH10_HI556_FRONT_ST_MIPI_RAW,
		{
...
#if defined(FH10_GC02M1B_MONO_LHYX_MIPI_RAW)
	{
		SENSOR_DRVNAME_FH10_GC02M1B_MONO_LHYX_MIPI_RAW,
		{
			{PDN, Vol_Low, 15},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#if defined(FH10_GC02M1_MICRO_LHYX_MIPI_RAW)
	{
		SENSOR_DRVNAME_FH10_GC02M1_MICRO_LHYX_MIPI_RAW,
		{
			{PDN, Vol_Low, 15},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#if defined(FH10_OV02B10_MICRO_CXT_MIPI_RAW)
	{
		SENSOR_DRVNAME_FH10_OV02B10_MICRO_CXT_MIPI_RAW,
		{
			{PDN, Vol_Low, 15},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#if defined(FH10_GC02M1_DEPTH_LHYX_MIPI_RAW)
	{
		SENSOR_DRVNAME_FH10_GC02M1_DEPTH_LHYX_MIPI_RAW,
		{
			{PDN, Vol_Low, 15},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#if defined(FH10_OV02B10_DEPTH_CXT_MIPI_RAW)
	{
		SENSOR_DRVNAME_FH10_OV02B10_DEPTH_CXT_MIPI_RAW,
		{
			{PDN, Vol_Low, 15},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
