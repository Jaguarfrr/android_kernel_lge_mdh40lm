...
#include "fh10_hi1336_rear_symipiraw_Sensor.h"
...
//+bug577281 zhoumin.wt, add, 2020/9/10, rear camera otp porting
...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = FH10_HI1336_REAR_SY_SENSOR_ID,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x325a, 0x7a30); //sreg13- BGR
	...
	write_cmos_sensor(0x1060, 0x0008); //mipi_static3
...
static struct stCAM_CAL_DATAINFO_STRUCT fh10_hi1336_rear_sy_eeprom_data ={
	.sensorID= FH10_HI1336_REAR_SY_SENSOR_ID,
	.deviceID = 0x01,
	.dataLength = 0x14AF,
...
static struct stCAM_CAL_CHECKSUM_STRUCT fh10_hi1336_rear_sy_checksum[8] =
{
	...
	{AF_ITEM,0x002D,0x002D,0x0032,0x0033,0x55},
	{LSC_ITEM,0x0034,0x0034,0x0780,0x0781,0x55},
	{PDAF_ITEM,0x0ED0,0x0ED0,0x14AC,0x14AD,0x55},
	{TOTAL_ITEM,0x0000,0x0000,0x14AD,0x14AE,0x55},
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				//+bug577281 zhoumin.wt, add, 2020/9/10, rear camera otp porting
				size = imgSensorReadEepromData(&fh10_hi1336_rear_sy_eeprom_data,fh10_hi1336_rear_sy_checksum);
				if(size != fh10_hi1336_rear_sy_eeprom_data.dataLength || (fh10_hi1336_rear_sy_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					pr_err("get eeprom data failed\n");
					if(fh10_hi1336_rear_sy_eeprom_data.dataBuffer != NULL) {
						kfree(fh10_hi1336_rear_sy_eeprom_data.dataBuffer);
						fh10_hi1336_rear_sy_eeprom_data.dataBuffer = NULL;
					}
					//*sensor_id = 0xFFFFFFFF;
					//return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					pr_debug("get eeprom data success\n");
					imgSensorSetEepromData(&fh10_hi1336_rear_sy_eeprom_data);
				}
				strcpy(rear_sensor_name, "hi1336rear_sunny");/*LGE_CHANGE, 2020-11-06, add the camera identifying logic , bk.bae@lge.com*/
				//-bug577281 zhoumin.wt, add, 2020/9/10, rear camera otp porting
...
UINT32 FH10_HI1336_REAR_SY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	printk("FH10_HI1336_REAR_SY_MIPI_RAW_SensorInit.\n");
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	FH10_HI1336_REAR_SY_MIPI_RAW_SensorInit	*/
