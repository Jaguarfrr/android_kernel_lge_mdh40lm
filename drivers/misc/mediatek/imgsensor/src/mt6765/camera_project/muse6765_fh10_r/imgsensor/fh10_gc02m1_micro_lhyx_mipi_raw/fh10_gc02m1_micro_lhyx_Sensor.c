 ...
 * Filename:
 * ---------
 *     fh10_gc02m1_micro_lhyx_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "fh10_gc02m1_micro_lhyx_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "fh10_gc02m1_camera_sensor"
...
extern char macro_sensor_name[20];/*LGE_CHANGE, 2020-11-06, add the camera identifying logic , bk.bae@lge.com*/

//+bug577281 chenbocheng.wt, add, 2020/9/9, camera otp porting
#define EEPROM_BL24SA64D_ID 0xA4
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = FH10_GC02M1_MICRO_LHYX_SENSOR_ID,
...
static struct stCAM_CAL_DATAINFO_STRUCT fh10_gc02m1_micro_lhyx_eeprom_data ={
	.sensorID= FH10_GC02M1_MICRO_LHYX_SENSOR_ID,
	.deviceID = 0x08,
	.dataLength = 0x077C,
...
static struct stCAM_CAL_CHECKSUM_STRUCT fh10_gc02m1_micro_lhyx_checksum[8] =
{
		...
		do {
			*sensor_id = return_sensor_id() + 1;
			if (*sensor_id == imgsensor_info.sensor_id) {
				//+bug577281 chenbocheng.wt, add, 2020/9/9, camera otp porting
				size = imgSensorReadEepromData(&fh10_gc02m1_micro_lhyx_eeprom_data,fh10_gc02m1_micro_lhyx_checksum);
				if(size != fh10_gc02m1_micro_lhyx_eeprom_data.dataLength || (fh10_gc02m1_micro_lhyx_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					pr_err("get eeprom data failed\n");
					if(fh10_gc02m1_micro_lhyx_eeprom_data.dataBuffer != NULL) {
						kfree(fh10_gc02m1_micro_lhyx_eeprom_data.dataBuffer);
						fh10_gc02m1_micro_lhyx_eeprom_data.dataBuffer = NULL;
					}
					//*sensor_id = 0xFFFFFFFF;
					//return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					pr_debug("get eeprom data success\n");
					imgSensorSetEepromData(&fh10_gc02m1_micro_lhyx_eeprom_data);
				}
				strcpy(macro_sensor_name, "gc02m1macro_unimage");/*LGE_CHANGE, 2020-11-06, add the camera identifying logic , bk.bae@lge.com*/
				//+bug577281 chenbocheng.wt, add, 2020/9/9, camera otp porting
...
UINT32 FH10_GC02M1_MICRO_LHYX_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	printk("FH10_GC02M1_MICRO_LHYX_MIPI_RAW_SensorInit.\n");
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}
