...
#include "fh10_hi846_front_stmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = FH10_HI846_FRONT_ST_SENSOR_ID,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x095A, 0xA3F3);
...
static struct stCAM_CAL_DATAINFO_STRUCT fh10_hi846_front_st_eeprom_data ={
	.sensorID= FH10_HI846_FRONT_ST_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x077C,
...
static struct stCAM_CAL_CHECKSUM_STRUCT fh10_hi846_front_st_checksum[8] =
{
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				//+bug577281 chenbocheng.wt, add, 2020/9/9, camera otp porting
				size = imgSensorReadEepromData(&fh10_hi846_front_st_eeprom_data,fh10_hi846_front_st_checksum);
				if(size != fh10_hi846_front_st_eeprom_data.dataLength || (fh10_hi846_front_st_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					pr_err("get eeprom data failed\n");
					if(fh10_hi846_front_st_eeprom_data.dataBuffer != NULL) {
						kfree(fh10_hi846_front_st_eeprom_data.dataBuffer);
						fh10_hi846_front_st_eeprom_data.dataBuffer = NULL;
					}
					//*sensor_id = 0xFFFFFFFF;
					//return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					pr_debug("get eeprom data success\n");
					imgSensorSetEepromData(&fh10_hi846_front_st_eeprom_data);
				}
				strcpy(front_sensor_name, "hi846front_shine");/*LGE_CHANGE, 2020-11-06, add the camera identifying logic , bk.bae@lge.com*/
				//-bug577281 chenbocheng.wt, add, 2020/9/9, camera otp porting
...
UINT32 FH10_HI846_FRONT_ST_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	printk("FH10_HI846_FRONT_ST_MIPI_RAW_SensorInit.\n");
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
