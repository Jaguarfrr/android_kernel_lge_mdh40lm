 ...
 * Filename:
 * ---------
 *	 fh10_s5k3l6_rear_dcmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "fh10_s5k3l6_rear_dcmipiraw_Sensor.h"
...
extern char rear_sensor_name[20];/*LGE_CHANGE, 2021-01-12, add the camera identifying logic , bk.bae@lge.com*/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = FH10_S5K3L6_REAR_DC_SENSOR_ID,
	...
	//++bug 577281,huangguoyong.wt,modify,2020/11/11,modify custom1 code for dualcam(s5k3l6+ov02b10)
	.custom1 = {//24 fps
		.pclk = 480000000,              //record different mode's pclk
		.linelength  = 4896,               //record different mode's linelength
...
//-bug550253 chenbocheng.wt, add, 2020/6/3, add custom2 for rear camera nightscape mode
	...
	.custom1_delay_frame = 2,//bug 577281,huangguoyong.wt,modify,2020/11/11,modify custom1 code for dualcam(s5k3l6+ov02b10)
...
static struct SENSOR_WINSIZE_INFO_STRUCT
	...
	{ 4208, 3120,	  0,  	0, 4208, 3120, 4208, 3120,   0,	0, 4208, 3120, 	 0, 0, 4208, 3120}, //bug 577281,huangguoyong.wt,modify,2020/11/11,modify custom1 code for dualcam(s5k3l6+ov02b10)
...
static struct stCAM_CAL_DATAINFO_STRUCT dongci_rear_s5k3l6_eeprom_data ={
	.sensorID= FH10_S5K3L6_REAR_DC_SENSOR_ID,
	.deviceID = 0x01,
	.dataLength = 0x1459,
...
static struct stCAM_CAL_CHECKSUM_STRUCT dongci_rear_s5k3l6_Checksum[8] =
{
	...
	{PDAF_ITEM,0x0ED0,0x0ED0,0x1456,0x1457,0x55},
	{TOTAL_ITEM,0x0000,0x0000,0x1457,0x1458,0x55},
			...
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) |
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(size != dongci_rear_s5k3l6_eeprom_data.dataLength || (dongci_rear_s5k3l6_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					...
					//+bug577281 zhoumin.wt, modify, 2020/11/6, second supply camera otp porting
				...
				strcpy(rear_sensor_name, "s5k3l6_dc");/*LGE_CHANGE, 2021-01-12, add the camera identifying logic , bk.bae@lge.com*/
				//-bug550253 chenbocheng.wt, modify, 2020/5/27,the s5k3l6 otp porting
...
UINT32 FH10_S5K3L6_REAR_DC_MIPI_RAW_SensorInit(
