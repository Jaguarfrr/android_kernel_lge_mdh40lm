...
#include "fh10_ov02b10_micro_cxtmipiraw_Sensor.h"

#define PFX "fh10_ov02b10_micro_cxt"
#define LOG_INF(format, args...)    \
	pr_info(PFX "[%s] " format, __func__, ##args)

extern char macro_sensor_name[20];/*LGE_CHANGE, 2021-01-12, add the camera identifying logic , bk.bae@lge.com*/

/* Camera Hardwareinfo */

//+bug577281 zhoumin.wt, add, 2020/11/6, second supply camera otp porting
#define EEPROM_GT24P64M22CSLITR_ID 0xA4
static kal_uint16 read_eeprom(kal_uint32 addr)
{
	kal_uint16 get_byte=0;

	char pu_send_cmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
	iReadRegI2C(pu_send_cmd, 2, (u8*)&get_byte, 1, EEPROM_GT24P64M22CSLITR_ID);
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = FH10_OV02B10_MICRO_CXT_SENSOR_ID,
...
static struct stCAM_CAL_DATAINFO_STRUCT fh10_ov02b10_micro_cxt_eeprom_data ={
	.sensorID= FH10_OV02B10_MICRO_CXT_SENSOR_ID,
	.deviceID = 0x08,
	.dataLength = 0x077C,
	.sensorVendorid = 0x160202FF,
	.vendorByte = {1,2,3,4},
	.dataBuffer = NULL,
};
static struct stCAM_CAL_CHECKSUM_STRUCT fh10_ov02b10_micro_cxt_checksum[8] =
{
        ...
        do {
            *sensor_id = return_sensor_id() + 1;
            if (*sensor_id == imgsensor_info.sensor_id) {
                //+bug577281 zhoumin.wt, add, 2020/11/6, second supply camera otp porting
                size = imgSensorReadEepromData(&fh10_ov02b10_micro_cxt_eeprom_data,fh10_ov02b10_micro_cxt_checksum);
                if(size != fh10_ov02b10_micro_cxt_eeprom_data.dataLength || (fh10_ov02b10_micro_cxt_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
                    pr_err("get eeprom data failed\n");
                    if(fh10_ov02b10_micro_cxt_eeprom_data.dataBuffer != NULL) {
                        kfree(fh10_ov02b10_micro_cxt_eeprom_data.dataBuffer);
                        fh10_ov02b10_micro_cxt_eeprom_data.dataBuffer = NULL;
                    }
                    *sensor_id = 0xFFFFFFFF;
                    return ERROR_SENSOR_CONNECT_FAIL;
                } else {
                    pr_debug("get eeprom data success\n");
                    imgSensorSetEepromData(&fh10_ov02b10_micro_cxt_eeprom_data);
                }
                strcpy(macro_sensor_name, "ov02b10macro_cxt");/*LGE_CHANGE, 2021-01-12, add the camera identifying logic , bk.bae@lge.com*/
...
UINT32 FH10_OV02B10_MICRO_CXT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
