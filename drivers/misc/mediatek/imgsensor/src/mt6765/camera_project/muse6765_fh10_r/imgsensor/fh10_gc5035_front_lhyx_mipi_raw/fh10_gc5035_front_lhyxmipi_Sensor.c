...
#include "fh10_gc5035_front_lhyxmipi_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = FH10_GC5035_FRONT_LHYX_SENSOR_ID,
...
static struct stCAM_CAL_DATAINFO_STRUCT fh10_gc5035_front_lhyx_eeprom_data ={
	.sensorID= FH10_GC5035_FRONT_LHYX_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x077C,
...
static struct stCAM_CAL_CHECKSUM_STRUCT fh10_gc5035_front_lhyx_checksum[8] =
{
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				gc5035_otp_identify();
				//+bug577281 chenbocheng.wt, add, 2020/9/9, camera otp porting
				size = imgSensorReadEepromData(&fh10_gc5035_front_lhyx_eeprom_data,fh10_gc5035_front_lhyx_checksum);
				if(size != fh10_gc5035_front_lhyx_eeprom_data.dataLength || (fh10_gc5035_front_lhyx_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					pr_err("get eeprom data failed\n");
					if(fh10_gc5035_front_lhyx_eeprom_data.dataBuffer != NULL) {
						kfree(fh10_gc5035_front_lhyx_eeprom_data.dataBuffer);
						fh10_gc5035_front_lhyx_eeprom_data.dataBuffer = NULL;
					}
					//*sensor_id = 0xFFFFFFFF;
					//return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					pr_info("get eeprom data success\n");
					imgSensorSetEepromData(&fh10_gc5035_front_lhyx_eeprom_data);
				}
				strcpy(front_sensor_name, "gc5035front_unimage");/*LGE_CHANGE, 2020-11-06, add the camera identifying logic , bk.bae@lge.com*/
				//-bug577281 chenbocheng.wt, add, 2020/9/9, camera otp porting
...
UINT32 FH10_GC5035_FRONT_LHYX_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	printk("FH10_GC5035_FRONT_LHYX_MIPI_RAW_SensorInit.\n");
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}
