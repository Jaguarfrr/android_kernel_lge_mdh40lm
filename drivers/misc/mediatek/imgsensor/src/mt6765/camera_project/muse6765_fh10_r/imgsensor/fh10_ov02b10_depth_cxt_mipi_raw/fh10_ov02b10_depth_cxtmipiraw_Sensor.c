...
#include "fh10_ov02b10_depth_cxtmipiraw_Sensor.h"

#define PFX "fh10_ov02b10_detph_cxt"
#define LOG_INF(format, args...)    \
	pr_debug(PFX "[%s] " format, __func__, ##args)

extern char depth_sensor_name[20];/*LGE_CHANGE, 2021-01-12, add the camera identifying logic , bk.bae@lge.com*/
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = FH10_OV02B10_DEPTH_CXT_SENSOR_ID,
...
static kal_uint16 set_gain(kal_uint16 gain)
{
    ...
    if((gain >= 0x40) && (gain <= (15.5*0x40))) //base gain = 0x40//bug 577281,huangguoyong.wt,modify,2020/11/13,modify custom1 code for dualcam(s5k3l6+ov02b10)
    {
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                strcpy(depth_sensor_name, "ov02b10depth_cxt");/*LGE_CHANGE, 2021-01-12, add the camera identifying logic , bk.bae@lge.com*/
...
UINT32 FH10_OV02B10_DEPTH_CXT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
