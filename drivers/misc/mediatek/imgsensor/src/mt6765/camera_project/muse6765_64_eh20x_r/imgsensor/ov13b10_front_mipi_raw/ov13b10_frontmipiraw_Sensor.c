...
#define PFX "ov13b10_front_camera_sensor"
...
#include "ov13b10_frontmipiraw_Sensor.h"
#define cam_pr_debug(format, args...)    \
	pr_debug(PFX "[%s] " format, __func__, ##args)

#define MULTI_WRITE 1
extern char front_sensor_name[20];/*LGE_CHANGE, 2020-11-06, add the camera identifying logic , bk.bae@lge.com*/
static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10_FRONT_SENSOR_ID,
...
static kal_uint16 ov13b10_front_table_write_cmos_sensor(
...
#if OV13B10_EEPROM_ENABLE
static kal_uint16 read_sensor_eeprom(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pu_send_cmd[2] = {(char)(addr >> 8), (char)(addr & 0xFF) };

	iReadRegI2C(pu_send_cmd, 2, (u8 *)&get_byte, 1, OV13B10_FRONT_TS_EEPROM);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10_front[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0321, 0x00,
	...
	0x484b, 0x01,
	0x4883, 0x02,
	0x5000, 0xfd, //pd on 0xff,
	0x5001, 0x0d, //pd on 0x0f,
	0x5045, 0x20,
	0x5046, 0x20,
	0x5047, 0xa4,
	0x5048, 0x20,
...
static void sensor_init(void)
{
	...
	ov13b10_front_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10_front,
		sizeof(addr_data_pair_init_ov13b10_front) / sizeof(kal_uint16));
#else
	cam_pr_debug("E\n");
	write_cmos_sensor(0x0103, 0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10_front[] = {
	0x0305, 0x23,
	0x3501, 0x06,
	0x3502, 0x10,
	0x3662, 0x88, 
...
#if MULTI_WRITE
	ov13b10_front_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10_front,
		sizeof(addr_data_pair_preview_ov13b10_front) / sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10_front[] = {
	0x0305, 0x46,
	0x3501, 0x0c,
	0x3502, 0x10,
	0x3662, 0x92,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10_front[] = {
	0x0305, 0x46,
	0x3501, 0x0c,
	0x3502, 0x10,
	0x3662, 0x92,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
		ov13b10_front_table_write_cmos_sensor(
			addr_data_pair_capture_15fps_ov13b10_front,
			sizeof(addr_data_pair_capture_15fps_ov13b10_front) /
			sizeof(kal_uint16));
	} else {
		ov13b10_front_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_ov13b10_front,
			sizeof(addr_data_pair_capture_30fps_ov13b10_front) /
			sizeof(kal_uint16));
	}
#else
	if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10_front[] = {
	0x0305, 0x46, 
	0x3501, 0x0c, 
	0x3502, 0x10, 
	0x3662, 0x92, 
...
#if MULTI_WRITE
	ov13b10_front_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10_front,
		sizeof(addr_data_pair_video_ov13b10_front) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x46); 
	write_cmos_sensor(0x3501, 0x0c); 
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10_front[] = {
	0x0305, 0x23, 
	0x3501, 0x02, 
	0x3502, 0x00, 
	0x3662, 0x84,
...
#if MULTI_WRITE
	ov13b10_front_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10_front,
		sizeof(addr_data_pair_hs_video_ov13b10_front) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x23); 
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10_front[] = {
	0x0305, 0x23, 
	0x3501, 0x06, 
	0x3502, 0x10,
	0x3662, 0x88, 
...
#if MULTI_WRITE
	ov13b10_front_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10_front,
		sizeof(addr_data_pair_slim_video_ov13b10_front) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x23); 
	write_cmos_sensor(0x3501, 0x06); 
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_ov13b10_front[] = {
	0x0305, 0x23, 
	0x3501, 0x0c, 
	0x3502, 0x10, 
	0x3662, 0x92, 
...
#if MULTI_WRITE
	ov13b10_front_table_write_cmos_sensor(
		addr_data_pair_custom1_ov13b10_front,
		sizeof(addr_data_pair_custom1_ov13b10_front) /
		sizeof(kal_uint16));
	write_cmos_sensor(0x0305, 0x23); 
	write_cmos_sensor(0x3501, 0x0c); 
	write_cmos_sensor(0x3502, 0x10); 
...
static int read_eeprom_barcode(void)
{
    ...
    if(barcodeFlag != 0x01)
    {
        printk("ov13b10_front barcodeFlag invalid !\n");
        return -1;
    }
    printk ("ov13b10_front  barcodeFlag valid !barcodeFlag =0x%x!\n",barcodeFlag);
    ...
    printk("ov13b10_front sn_code:%s",sn_code);
    ...
    printk("ov13b10_front barcode checksum error\n");
    return -1;
}
...
static int  get_eeprom_data(EEPROM_DATA *data)
{
	...
	for (i =0x00;i <= 0x0E;i++,otp_data++) {
		*otp_data = read_sensor_eeprom(i);
		...
		printk("[ov13b10_front otp]%s :[1][0x%x]=[0x%x]",__func__, i,*otp_data);
	}

	read_checksum = read_sensor_eeprom(0x0F);
	checksum = (checksum%255)+1;
	printk("[ov13b10_front otp]%s :[2][0x%x]=[0x%x]",__func__, checksum,read_checksum);
	read_eeprom_barcode();
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				strcpy(front_sensor_name, "ov13b10front_kingcome");/*LGE_CHANGE, 2020-11-06, add the camera identifying logic , bk.bae@lge.com*/
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		cam_pr_debug("ov13b10_front imgsensor id: 0x%x fail\n", *sensor_id);
...
static kal_uint32 custom1(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
			MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
       printk("[ov13b10_front] custom1 mode start\n");
	spin_lock(&imgsensor_drv_lock);
...
UINT32 OV13B10_FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	printk("OV13B10_FRONT_MIPI_RAW_SensorInit.\n");
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}
